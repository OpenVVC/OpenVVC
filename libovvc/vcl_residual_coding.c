                        ...
                        uint16_t last_pos)
{
    ...
    if(!last_cg_y){
        ...
        if (log2_tb_h <= 2) {
            ...
            if (last_y >= 2) {
                ...
                int16_t cg_offset = 2 * VVC_TR_CTX_STRIDE;
    ...
    int16_t sb_pos    =  last_cg_y << 4;
    int16_t cg_offset = (last_cg_y << 3) * VVC_TR_CTX_STRIDE;

    int16_t num_cg = last_cg_y;

    int16_t x = last_x;
    int16_t y = last_y - (last_cg_y << 3);
