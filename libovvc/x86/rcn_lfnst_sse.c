...
lfnst_4x4_16(const int16_t* const src, __m128i* r,
             const int8_t* const lfnst_matrix)
             {
               int32_t* const _src = (int32_t*) src;
                    ...
                    l[0]  = _mm_cvtepi8_epi16(c[0] );
                    l[1]  = _mm_cvtepi8_epi16(c[1] );
                    l[2]  = _mm_cvtepi8_epi16(c[2] );
                    l[3]  = _mm_cvtepi8_epi16(c[3] );
                    l[4]  = _mm_cvtepi8_epi16(c[4] );
                    l[5]  = _mm_cvtepi8_epi16(c[5] );
                    l[6]  = _mm_cvtepi8_epi16(c[6] );
                    l[7]  = _mm_cvtepi8_epi16(c[7] );
                    l[8]  = _mm_cvtepi8_epi16(c[8] );
                    l[9]  = _mm_cvtepi8_epi16(c[9] );
                    l[10] = _mm_cvtepi8_epi16(c[10]);
                    l[11] = _mm_cvtepi8_epi16(c[11]);
                    l[12] = _mm_cvtepi8_epi16(c[12]);
                    l[13] = _mm_cvtepi8_epi16(c[13]);
                    l[14] = _mm_cvtepi8_epi16(c[14]);
                    l[15] = _mm_cvtepi8_epi16(c[15]);

                    l[16] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[0] , 8));
                    l[17] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[1] , 8));
                    l[18] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[2] , 8));
                    l[19] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[3] , 8));
                    l[20] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[4] , 8));
                    l[21] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[5] , 8));
                    l[22] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[6] , 8));
                    l[23] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[7] , 8));
                    l[24] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[8] , 8));
                    l[25] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[9] , 8));
                    l[26] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[10], 8));
                    l[27] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[11], 8));
                    l[28] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[12], 8));
                    l[29] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[13], 8));
                    l[30] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[14], 8));
                    l[31] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[15], 8));
...
lfnst_4x4_8(const int16_t* const src, __m128i* r,
             const int8_t* const lfnst_matrix)
             {
               ...
               l[6]  = _mm_cvtepi8_epi16(c[6] );
               l[7]  = _mm_cvtepi8_epi16(c[7] );
               l[8]  = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[0] , 8));
               l[9]  = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[1] , 8));
               l[10] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[2] , 8));
               l[11] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[3] , 8));
               l[12] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[4] , 8));
               l[13] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[5] , 8));
               l[14] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[6] , 8));
               l[15] = _mm_cvtepi8_epi16(_mm_bsrli_si128(c[7] , 8));
...
lfnst_8x8_16(const int16_t* const src, __m128i* r,
            const int8_t* const lfnst_matrix)
            {
              int32_t* const _src = (int32_t*) src;
                   ...
                   /* FIXME reorder LFNST matrix storage to avoid swizzle */
                   d[0]  = _mm_unpacklo_epi16(l[0], l[1]);
                   d[1]  = _mm_unpackhi_epi16(l[0], l[1]);
                   d[2]  = _mm_unpacklo_epi16(l[2], l[3]);
                   d[3]  = _mm_unpackhi_epi16(l[2], l[3]);
